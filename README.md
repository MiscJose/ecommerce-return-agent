...
- **Deployment:** Decided. The project currently runs locally via Docker Compose and is tested through `curl` and a local `test.py` script; production deployment will use:
